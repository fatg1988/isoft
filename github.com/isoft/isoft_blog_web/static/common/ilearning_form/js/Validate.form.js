...
$.extend(validateFunction, {
    ...
    FORM_validate:function() {
        ...
        $("#department").ilearningValidate(validatePrompt.department, validateFunction.department, true);
        $("#tel").ilearningValidate(validatePrompt.tel, validateFunction.tel, true);
        $("#mobile").ilearningValidate(validatePrompt.mobile,validateFunction.mobile,true);
        $("#mail").ilearningValidate(validatePrompt.mail, validateFunction.mail, true);
        $("#companyname").ilearningValidate(validatePrompt.companyname, validateFunction.companyname, true);
        $("#companyaddr").ilearningValidate(validatePrompt.companyaddr, validateFunction.companyaddr, true);
        $("#companysite").ilearningValidate(validatePrompt.companysite,validateFunction.companysite,true);
        $("#purpose").ilearningValidate(validatePrompt.purpose, validateFunction.purpose, true);
...
$(function () {
    ...
    //用户名验证
    $("#username").ilearningValidate(validatePrompt.username, validateFunction.username);
    //密码验证
    ...
    //邮箱验证
    $("#mail").ilearningValidate(validatePrompt.mail, validateFunction.mail);
    //推荐人用户名
    ...
    //联系人姓名验证
    $("#realname").ilearningValidate(validatePrompt.realname, validateFunction.realname);
    //部门验证
    $("#department").ilearningValidate(validatePrompt.department, validateFunction.department);
    //固定电话验证
    $("#tel").ilearningValidate(validatePrompt.tel, validateFunction.tel);
    //手机验证
    $("#mobile").ilearningValidate(validatePrompt.mobile, validateFunction.mobile);
    //公司名称验证
    $("#companyname").ilearningValidate(validatePrompt.companyname, validateFunction.companyname);
    //公司地址验证
    $("#companyaddr").ilearningValidate(validatePrompt.companyaddr, validateFunction.companyaddr);
    //公司网址验证
    $("#companysite").ilearningValidate(validatePrompt.companysite, validateFunction.companysite);
    //显示密码事件
